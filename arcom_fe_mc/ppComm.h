/*! \file   ppComm.h
    ...
    \$Id: ppComm.h,v 1.15 2008/03/10 22:15:43 avaccari Exp $
    ...
    #define WAIT_ON_AMBSI_NOT_READY 5       // Number of seconds to wait before checking AMBSI status at initialization
    /* Globals */
    /* Externs */
