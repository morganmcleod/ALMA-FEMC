...
*/
static char *chgext(char *path, char *oldext, char *newext)
{
      char *p;
...
static FILE *cant(char *fname, char *fmode)
{
      FILE *fp;
...
**           -2 for error opening file
**           -3 for error handling the file
**           -4 for error closing the file
*/
