...
/*! \defgroup   compressor       FETIM compressor
    ...
    /*! This structure represent the current state of the FETIM compressor system
        ...
        \param      feStatus     This contains the state of the FE cryogenics.
        ...
        \param      intrlkStatus This contains the current status of the
                                     compressor interlock system:
                                        - \ref ERROR -> Interlock triggered
                                        - \ref OK    -> Interlock ok
        \param      cableStatus  This contains the currenst status of the
